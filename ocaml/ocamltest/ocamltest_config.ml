...
let ocamlsrcdir = "/home/mali54/ocaml"
...
let mkexe = "gcc -O2 -fno-strict-aliasing -fwrapv -pthread -Wall -Wdeclaration-after-statement -Werror -fno-common -fexcess-precision=standard -fno-tree-vrp -ffunction-sections  -Wl,-E "

let bytecc_libs = "-lm -ldl  -lpthread"

let nativecc_libs = "-lm -ldl  -lpthread"
