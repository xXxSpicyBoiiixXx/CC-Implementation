...
let idx__gc_regs_slot = curr in let curr = curr + 1 in
...
let idx__eventlog_buffer = curr in let curr = curr + 1 in
...
| Domain_gc_regs_slot -> idx__gc_regs_slot
...
| Domain_eventlog_buffer -> idx__eventlog_buffer
